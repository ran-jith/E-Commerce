...
<div class="span3">
  <center>
    <form class="form-horizontal" action="validateadmin.jsp" method="post">
     <div class="form-group">
       ...
       <div class="col-sm-5">
           <input type="password" class="form-control" id="pwd"  name="passwd">
             ...
             &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit"  class="btn btn-primary btn-lg"value="Log In" onclick="form.action='validateadmin.jsp';">
                      </div></form>
  </center>
</div>
